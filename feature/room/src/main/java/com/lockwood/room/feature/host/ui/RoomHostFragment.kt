...
internal class RoomHostFragment : BaseFragment<RoomHostViewState>(), IHostView {
    ...
    private val appContext: Context
        get() {
            val contextProvider = (context.applicationContext as ApplicationContextProvider)
    ...
    override fun onEvent(event: Event) = when (event) {
        ...
        is StopHostServiceEvent -> appContext.startService<HostForegroundService> {
            action = BaseRoomService.STOP_SERVICE
        }
