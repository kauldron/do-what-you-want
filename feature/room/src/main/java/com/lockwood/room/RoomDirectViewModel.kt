...
import com.lockwood.room.DirectState.ADD_LOCAL_SERVICES
import com.lockwood.room.DirectState.DISCOVER_SERVICES
import com.lockwood.room.DirectState.REQUEST_SERVICES
...
internal class RoomDirectViewModel(
	...
	private fun discoverServices() {
		...
		wifiDirectManager.discoverServices(
				listener = p2pListenerWithSuccess { startRegistration() }
		)
	}
	...
	private fun startRegistration() {
		...
		wifiDirectManager.addLocalService(
				...
				listener = p2pListenerWithSuccess {
					offerEvent { MessageEvent("addLocalService") }
				}
		)
	}
