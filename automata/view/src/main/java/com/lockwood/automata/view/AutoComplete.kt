...
inline fun AutoCompleteTextView.setStringAdapter(
		...
		crossinline onItemSelected: AutoCompleteTextView.(AdapterView<*>, Int, Long) -> Unit =
				{ _, _, _ ->
					dismissDropDown()
				},
) {
...
) = setOnItemClickListener { parent, _, position, id -> onItemSelected(parent, position, id) }
